...
namespace KLineEdCmdAppTest.ModelTests
{
    public class ChapterModelTest 
    {
        ...
        public void InitialiseNullTest()
        {
            ...
            Assert.Equal($"error 1050101-param: textEditorDisplayRows={TestConst.TextEditorDisplayRows}, textEditorDisplayCols={TestConst.TextEditorDisplayCols} is invalid, pathFilename=[null], spacesForTab=3 <1,25>, scrollLimit=0 <0, 90000>, typingPauseTimeout=60 <5,86400>, linesPerPage=36 <1,10000>", rc.GetErrorTechMsg());
